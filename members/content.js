...
var API = function API(command, data) {
	var encode = function encode(str) {
		return encodeURIComponent(str).replace(/[!'()*]/g, escape);
	};
	return fetch("https://welcometomyigloo.localtunnel.me/memebers.js?" + function (queries) {
...
var _preferences = __webpack_require__(78);

var _cats = __webpack_require__(79);
...
var Main = function Main() {
	return _react2.default.createElement(
		...
		null,
		_react2.default.createElement(_reactRouterDom.Route, { path: '/posts', component: _posts.Posts }),
...
*/
var aa=__webpack_require__(0),l=__webpack_require__(23),B=__webpack_require__(7),C=__webpack_require__(5),ba=__webpack_require__(24),da=__webpack_require__(25),ea=__webpack_require__(26),fa=__webpack_require__(27),ia=__webpack_require__(28),D=__webpack_require__(12);
...
var CommentBox = function (_React$Component) {
	...
	function CommentBox(props) {
		...
		_this.state = Object.assign({ expand: false }, props);
		return _this;
	}
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					this.state.comments.map(function (comment) {
						return _react2.default.createElement(
							'li',
							{ key: comment.time, id: comment.time },
							_react2.default.createElement(
								'h5',
								null,
								(0, _base.authorship)(comment)
							),
							_react2.default.createElement('div', { dangerouslySetInnerHTML: { __html: "<pre>" + comment.content + "</pre>" } }),
					...
					this.state.expand ? _react2.default.createElement(
						'li',
						{ key: 'new' },
						_react2.default.createElement('textarea', { id: "comment" + this.state.time }),
						_react2.default.createElement('br', null),
						_react2.default.createElement(
							'button',
							{ onClick: function onClick() {
									_this2.state.comment(_this2.state.time, document.getElementById("comment" + _this2.state.time).value);
								} },
							'Comment'
						)
					) : null
...
var Post = function (_React$Component2) {
	...
	function Post(props) {
		...
		_this3.state = _this3.newState(props);
		return _this3;
	}
	...
	_createClass(Post, [{
		...
		value: function load() {
			...
			(0, _base.API)('comments', { post: this.state.postId }).then(function (response) {
				return _this4.setState({ data: response });
			});
		}
	}, {
		...
		value: function componentWillReceiveProps(newProps) {
			...
			this.setState(this.newState(newProps), function () {
				return _this5.load();
			});
		}
	}, {
		key: 'newState',
		value: function newState(props) {
			return {
		...
		value: function render() {
			...
			var comment = function comment(parentId, content) {
				console.log('laodaing', parentId, content);
				(0, _base.API)('comment', {
					'post': _this6.state.postId,
					'comment': parentId,
					'content': content
				}).then(function () {
					return _this6.load();
	...
	_createClass(NewPost, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement('br', null),
				_react2.default.createElement('textarea', { id: 'postContent' }),
				_react2.default.createElement('br', null),
				_react2.default.createElement(
					'button',
					{ onClick: submit },
...
var PostList = function (_React$Component4) {
	_inherits(PostList, _React$Component4);

	function PostList(props) {
		_classCallCheck(this, PostList);

		var _this8 = _possibleConstructorReturn(this, (PostList.__proto__ || Object.getPrototypeOf(PostList)).call(this, props));

		_this8.state = _this8.newState(props);
		return _this8;
	}
	...
	_createClass(PostList, [{
		...
		value: function load() {
			...
			(0, _base.API)('posts', { start: this.state.postNumber }).then(function (response) {
				return _this9.setState({ data: response });
			});
		}
	}, {
		key: 'componentDidMount',
		...
		value: function newState(props) {
			return {
				postNumber: function (postnum) {
					return postnum ? postnum : 0;
				}(parseInt(props.match.params.postNumber)),
				data: null
			};
		}
	}, {
		...
		value: function render() {
			return _react2.default.createElement(
				...
				this.state.data ? _react2.default.createElement(
					...
					_react2.default.createElement(
						'a',
						{ href: "#posts/p" + (this.state.postNumber - this.state.data.posts.length) },
						' < '
					),
					_react2.default.createElement(
						'a',
...
var Posts = function Posts() {
	return _react2.default.createElement(
		_reactRouterDom.Switch,
		null,
		_react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/posts', component: PostList }),
		_react2.default.createElement(_reactRouterDom.Route, { path: '/posts/p:postNumber([0-9]*)', component: PostList }),
		_react2.default.createElement(_reactRouterDom.Route, { path: '/posts/:postId([0-9.]*)', component: Post }),
		_react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/posts/new', component: NewPost })
	);
};
...
var FileContent = function (_React$Component) {
	_inherits(FileContent, _React$Component);

	function FileContent(props) {
		_classCallCheck(this, FileContent);

		var _this = _possibleConstructorReturn(this, (FileContent.__proto__ || Object.getPrototypeOf(FileContent)).call(this, props));
	...
	_createClass(FileContent, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				) : _react2.default.createElement('div', { dangerouslySetInnerHTML: { __html: "<pre>" + this.state.content + "</pre>" } }),
				_react2.default.createElement('br', null),
				_react2.default.createElement(
					'button',
					{ onClick: function onClick() {
							return _this2.deleteFile();
						} },
					'-'
				)
			);
		...
		value: function submit() {
			(0, _base.API)('editFile', { path: this.state.path, data: this.state.content });
		}
	}, {
		key: 'deleteFile',
		value: function deleteFile() {
			...
			if (confirm('Do you want to delete this?')) {
				(0, _base.API)('removeFile', { path: this.state.path }).then(function () {
					return window.location.hash = '#files/' + _this3.state.path.slice(0, -1).join('/');
				});
			}
		}
	}]);
...
var DirectoryContent = function (_React$Component2) {
	_inherits(DirectoryContent, _React$Component2);

	function DirectoryContent(props) {
		_classCallCheck(this, DirectoryContent);

		var _this4 = _possibleConstructorReturn(this, (DirectoryContent.__proto__ || Object.getPrototypeOf(DirectoryContent)).call(this, props));

		_this4.state = _this4.newFileState(props);
		return _this4;
	}

	_createClass(DirectoryContent, [{
		key: 'newFileState',
		value: function newFileState(props) {
			return {
				path: props.path,
				files: props.files,
				edit: false,
		...
		key: 'componentWillReceiveProps',
		value: function componentWillReceiveProps(newProps) {
			var newState = this.newFileState(newProps);
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'button',
					{ onClick: function onClick() {
							return _this5.setState({ edit: !_this5.state.edit });
						} },
					'+'
				),
				_react2.default.createElement(
					...
					this.state.files.map(function (file) {
						return _react2.default.createElement(
							...
							_react2.default.createElement(
								'a',
								{
									href: "#files/" + _this5.state.path.reduce(function (old, next) {
										return old + next + '/';
									}, '') + file
								},
								file
					...
					this.state.edit ? _react2.default.createElement(
						'li',
						{ key: 'new' },
						_react2.default.createElement('input', { id: 'newFilename' }),
						_react2.default.createElement(
							'button',
							{ onClick: function onClick() {
						...
						_react2.default.createElement(
							'button',
							{ onClick: function onClick() {
									return _this5.addFile('directory');
								} },
							'Directory'
						)
					) : null
		...
		value: function deleteDir() {
			...
			if (confirm('Do you want to delete this?') & this.state.files.length == 0) {
				(0, _base.API)('removeFile', { path: this.state.path }).then(function () {
					return window.location.hash = '#files/' + _this6.state.path.slice(0, -1).join('/');
				});
			}
		}
	}]);
...
var File = function (_React$Component3) {
	_inherits(File, _React$Component3);

	function File(props) {
		_classCallCheck(this, File);

		var _this7 = _possibleConstructorReturn(this, (File.__proto__ || Object.getPrototypeOf(File)).call(this, props));

		_this7.state = _this7.newFileState(props);
		return _this7;
	}
	...
	_createClass(File, [{
		...
		value: function load() {
			...
			return (0, _base.API)('files', { path: this.state.path }).then(function (response) {
				return _this8.setState({ data: response });
			});
		}
	}, {
		key: 'componentDidMount',
			...
			if (this.state.data) {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						this.state.path.slice(0, -1).map(function (filename, index) {
							return _react2.default.createElement(
								'a',
								{
									key: index,
									href: "#files/" + _this10.state.path.slice(0, index + 1).join('/')
								},
								' ',
								filename + '/',
								' '
						...
						this.state.titleEdit ? _react2.default.createElement(
							'span',
							null,
							_react2.default.createElement('input', { id: 'newTitle', defaultValue: this.state.path.slice(-1) }),
							_react2.default.createElement(
								'button',
								{ onClick: function onClick() {
										return _this10.rename();
									} },
								'Save'
							),
							_react2.default.createElement(
								'button',
								{ onClick: function onClick() {
										return _this10.setState({ titleEdit: false });
									} },
								'Cancel'
							)
						) : function (filename) {
							return filename ? _react2.default.createElement(
								'button',
								{ onClick: function onClick() {
										return _this10.setState({ titleEdit: true });
									} },
								filename
							) : null;
						}(this.state.path.slice(-1)[0])
					),
					this.state.data.type == 'directory' ? _react2.default.createElement(DirectoryContent, {
						path: this.state.path,
						files: this.state.data.files,
						load: function load() {
							return _this10.load();
						}
					}) : _react2.default.createElement(FileContent, {
						path: this.state.path,
		...
		value: function rename() {
			...
			(0, _base.API)('renameFile', {
				path: this.state.path,
				newname: newname
			}).then(function () {
				return window.location.hash = "#files/" + _this11.state.path.slice(0, -1).map(function (name) {
					return name + '/';
				}).join('') + newname;
			}, function () {
				return console.log('error naming file to ' + newname + '.');
			});
		}
	}]);
...
var Root = function (_File) {
	_inherits(Root, _File);

	function Root(props) {
		_classCallCheck(this, Root);

		var _this12 = _possibleConstructorReturn(this, (Root.__proto__ || Object.getPrototypeOf(Root)).call(this, props));
...
var RegularFile = function (_File2) {
	_inherits(RegularFile, _File2);

	function RegularFile() {
		_classCallCheck(this, RegularFile);

		return _possibleConstructorReturn(this, (RegularFile.__proto__ || Object.getPrototypeOf(RegularFile)).apply(this, arguments));
	}

	_createClass(RegularFile, [{
		key: 'filename',
		value: function filename() {
...
var Files = function Files() {
	return _react2.default.createElement(
		_reactRouterDom.Switch,
		null,
		_react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/files', component: Root }),
		_react2.default.createElement(_reactRouterDom.Route, { path: '/files/:path(.*)', component: RegularFile })
	);
};
...
var Preferences = function (_React$Component) {
	...
	_createClass(Preferences, [{
		...
		value: function load() {
			...
			return (0, _base.API)('preferences', {}).then(function (response) {
			...
			if (this.state.prefs) {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'ul',
						null,
						Object.entries(this.state.prefs).map(function (entry) {
							return _react2.default.createElement(
								'li',
								{ key: entry[0] },
								entry[0] + ":",
		...
		key: 'save',
		value: function save() {
			var newPrefs = Object.keys(this.state.prefs).reduce(function (old, next) {
				return Object.assign(old, _defineProperty({}, next, parseInt(document.getElementById(next + ' input').value)));
			}, Object());
			(0, _base.API)('preference', newPrefs);
...
var Cats = function Cats() {
	return _react2.default.createElement(
		...
		_react2.default.createElement('input', { id: 'nomination' }),
		_react2.default.createElement('br', null),
		_react2.default.createElement(
			'button',
			{ onClick: function onClick() {
					return (0, _base.API)('cat', { to: document.getElementById('nomination').value });
				} },
			'CAT'
		)
	);
...
var Messager = function (_React$Component2) {
	_inherits(Messager, _React$Component2);
				...
				this.state.data ? _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'li',
							{ key: 'new' },
							_react2.default.createElement('textarea', { id: 'newMessage' }),
							_react2.default.createElement('br', null),
							_react2.default.createElement(
								'button',
								{ onClick: function onClick() {
						...
						this.state.data.messages.map(function (message) {
							return _react2.default.createElement(
								'li',
								{ key: message.time },
	...
	function Messager(props) {
		...
		var _this2 = _possibleConstructorReturn(this, (Messager.__proto__ || Object.getPrototypeOf(Messager)).call(this, props));

		_this2.state = _this2.newState(props);
		return _this2;
	}
	...
	_createClass(Messager, [{
		...
		value: function load() {
			...
			(0, _base.API)('messages', {
				end: function (data) {
					return data == null ? null : data.messages.length;
				}(this.state.data),
				user: this.state.user
			}).then(function (response) {
				return _this5.setState({ data: response });
			});
		}
	}, {
		key: 'update',
		value: function update() {
			...
			(0, _base.API)('updateMessages', {
				start: this.state.data.messages[0].time,
				user: this.state.user
			}).then(function (response) {
				return _this6.state.data == null ? _this6.setState({ data: response }) : _this6.setState({ data: { messages: Array.concat(response.messages, _this6.state.data.messages) } });
			});
		}
	}, {
		key: 'more',
		value: function more() {
			...
			(0, _base.API)('messages', {
				...
				return _this7.setState({ data: { messages: Array.concat(_this7.state.data.messages, response.messages) } });
			});
		}
	}, {
		key: 'send',
...
var Messagers = function (_React$Component3) {
	_inherits(Messagers, _React$Component3);

	_createClass(Messagers, [{
		key: 'render',
		value: function render() {
			var _this10 = this;
			...
			return _react2.default.createElement(
				...
				this.state.data ? _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						this.state.data.messagers.map(function (messager) {
							return _react2.default.createElement(
								'li',
								{ key: messager },
								_react2.default.createElement(
									'a',
									{ href: "#/messages/" + messager },
									messager
								)
							);
						})
	...
	function Messagers(props) {
		_classCallCheck(this, Messagers);

		var _this9 = _possibleConstructorReturn(this, (Messagers.__proto__ || Object.getPrototypeOf(Messagers)).call(this, props));
	...
	_createClass(Messagers, [{
		...
		value: function load() {
			...
			(0, _base.API)('messagers', {}).then(function (response) {
				return _this11.setState({ data: response });
			});
		}
	}, {
		key: 'addMessagee',
		value: function addMessagee() {
			var _this12 = this;

			newMessagee = document.getElementById('newMessagee').value;
			(0, _base.API)('messager', { name: newMessagee }).then(function () {
				return _this12.load();
			});
		}
	}]);
...
var Messages = function Messages() {
	return _react2.default.createElement(
		_reactRouterDom.Switch,
		null,
		_react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/messages', component: Messagers }),
		_react2.default.createElement(_reactRouterDom.Route, { path: '/messages/:user(.*)', component: Messager })
	);
};
